...
const FIRST_ITEM_CANDIDATES = new Set([
    ...
    // Legendary items
    3001, 3003, 3004, 3011, 3015, 3026, 3031, 3033, 3036, 3040, 3042, 3046, 3047, 3050, 3053, 3059, 3065, 3068, 3071, 3072, 3074, 3075,
    3078, 3083, 3089, 3091, 3094, 3095, 3100, 3102, 3107, 3109, 3110, 3115, 3116, 3118, 3119, 3121, 3124, 3133, 3135, 3139, 3140, 3142,
    3143, 3144, 3146, 3147, 3151, 3152, 3153, 3156, 3157, 3158, 3161, 3165, 3171, 3172, 3175, 3179, 3180, 3181, 3190, 3193, 3222, 3504, 3508, 3513,
    3599, 3742, 3814, 4005, 4401, 4403, 4628, 4629, 4630, 4632, 4633, 4636, 4637, 4638, 4643, 4644, 4645, 4646, 6029, 6035, 6333,
...
function analyzeItems(games, role) {
    ...
    // Берем предметы из itemFrequency, отсортированные по PICK RATE
    // Это даст самые популярные предметы в билде
    const itemsByPickRate = Object.entries(itemFrequency)
        .filter(([id]) => {
        ...
        .sort((a, b) => {
            // Сортируем по PICK RATE (убывание) - самые популярные первыми
